...
import org.puppylab.cryptodrive.core.VaultConfig.RecoveryConfig;
import org.puppylab.cryptodrive.util.Base64Utils;
import org.puppylab.cryptodrive.util.EncryptUtils;
import org.puppylab.cryptodrive.util.HashUtils;
...
public abstract class OAuthAuthenticator {
    ...
    public OAuthAuthenticator() {
        ...
        // load config:
        RecoveryConfig rc = null;
        this.config = JsonUtils.fromJson(rc.oauthConfigJson, Map.class);
        logger.info("Load oauth provider {}: {}", provider, rc.oauthConfigJson);
    }
